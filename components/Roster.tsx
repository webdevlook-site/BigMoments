...
const players: EnhancedPlayer[] = [
  { 
    ...
    age: 22, 
    club: "FK IMT", 
    imageUrl: "https://placehold.co/600x800/1e293b/FFFFFF?text=Charles+Shedrack",
    dob: "10.07.2003",
    featured: true 
  },
  { 
    ...
    age: 21, 
    club: "FC Grafičar", 
    imageUrl: "https://placehold.co/600x800/1e293b/FFFFFF?text=Jusuf+Faisal",
    dob: "06.08.2004",
  },
  { 
    id: 3, 
    ...
    imageUrl: "https://placehold.co/600x800/1e293b/FFFFFF?text=Favour+Ogbu",
    dob: "26.06.2004",
  }
];
...
const Roster: React.FC = () => {
  return (
    <section id={SectionId.PLAYERS} className="py-24 bg-slate-900 relative overflow-hidden">
      {/* Background Accents */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
          ...
          <div className="md:text-right max-w-md">
            <p className="text-slate-400 text-lg leading-relaxed">
              We represent carefully selected professionals with exceptional skill and character. 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {players.map((player) => (
            <div key={player.id} className="group relative h-[500px] rounded-3xl overflow-hidden bg-slate-800 border border-slate-700 hover:border-lime-500/50 transition-all duration-500 shadow-2xl hover:shadow-[0_0_40px_rgba(132,204,22,0.15)]">
              ...
              <div className="absolute inset-0 z-10 flex flex-col justify-end p-6 sm:p-8">
                ...
                <div className="transition-transform duration-500">
                    <div className="mb-1">
                        ...
                        <h3 className="text-3xl font-black text-white leading-none mb-1">{player.name}</h3>
                        <p className="text-slate-300 font-medium text-lg">{player.club}</p>
                    </div>
                    ...
                    <div className="max-h-0 opacity-0 group-hover:max-h-[300px] group-hover:opacity-100 overflow-hidden transition-all duration-500 ease-out">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-white/10 pb-2">
                            <div>
                                ...
                                <p className="text-white font-mono font-bold">{player.dob}</p>
                            </div>
                            <div>
                                <p className="text-slate-500 text-xs uppercase tracking-wider font-bold mb-1 flex items-center gap-1">
                                    <User className="w-3 h-3" /> Age
                                </p>
                                <p className="text-white font-mono font-bold">{player.age} Years</p>
                            </div>
                        </div>
                    </div>
                </div>
